...
return [
    ...
    'people_list_filter_tag' => 'Mostrando todos os contatos marcados com <span class="pretty-tag">:name</span>',
    'people_list_clear_filter' => 'Limpar filtros',
    'people_list_contacts_per_tags' => '{0} 0 contato|{1,1} 1 contato|{2,*} :count contatos',
    ...
    'people_add_birthday_reminder' => 'Deseje um feliz aniversário para :name',
    'people_add_import' => 'Você deseja <a href="/settings/import">importar seus contatos</a>?',
    ...
    'information_edit_avatar' => 'Foto do contato',
    ...
    'information_edit_facebook' => 'Perfil no Facebook (opcional)',
    'information_edit_twitter' => 'Perfil no Twitter (opcional)',
    'information_edit_linkedin' => 'Perfil no LinkedIn (opcional)',
    ...
    'information_no_facebook_defined' => 'Facebook não definido',
    'information_no_twitter_defined' => 'Twitter não definido',
    'information_no_linkedin_defined' => 'LinkedIn não definido',
    'information_no_work_defined' => 'Nenhum informação sobre trabalho',
    ...
    'work_edit_title' => 'Atualizar informações de trabalho do(a) :name',
    ...
    'gifts_gift_already_offered' => 'Presentes já oferecidos',
    'gifts_table_date_added' => 'Data adicionada',
    'gifts_table_description' => 'Descrição',
    'gifts_table_actions' => 'Ações',
    ...
    'debt_add_title' => 'Adicionando dívida',
    ...
    'debts_blank_title' => 'Gerencie as dívidas que você deve para :name ou :name deve para você',
